...
class ProductivityTimerApp:
    def __init__(self, root):
        ...
        self.mute_button = tk.Button(self.root, text="Mute", command=self.toggle_sound)
 ...
 #       self.delete_task_button.pack()
        # Next task button
        self.next_task_button = tk.Button(root, text="Next Task", command=self.load_next_task)
    ...
    def create_widgets(self):
        ...
        self.reset_timer_button.pack(side=tk.LEFT)
        ...
        # Backup tasks button
        self.backup_button = tk.Button(self.buttons_frame, text="Backup Tasks", command=self.backup_tasks)
        ...
        self.fetch_tasks_button.pack(side=tk.LEFT)

        # swap active task button with first position (commented out for swapping first position)
        self.swap_task_button = tk.Button(self.buttons_frame, text="Swap Active Task", command=self.swap_active_task)
        self.swap_task_button.pack(side=tk.LEFT)
        # swap active task with highlighted task
        self.swap_task_button = tk.Button(self.buttons_frame, text="Swap Active Task", command=self.swap_active_task)

        # Create a button to move the selected task to the top
        self.move_task_button = tk.Button(self.root, text="Move Task to Top", command=self.move_task_to_top)
        self.move_task_button.pack()
